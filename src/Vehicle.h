...
class Vehicle : public TrafficObject, public std::enable_shared_from_this<Vehicle> //TODO: read up on that concept of  std::enable_shared_from_this<Vehicle>
{
public:
    ...
    void simulate(); // override fct from traffic object

    // miscellaneous
    std::shared_ptr<Vehicle> get_shared_this() { return shared_from_this(); } // enable class to pass "this" as a pointer
